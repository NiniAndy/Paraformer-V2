...
from funasr.models.paraformer.decoder import DecoderLayerSANM



@tables.register("decoder_classes", "ParaformerV2SANMDecoder")
class ParaformerV2SANMDecoder(BaseTransformerDecoder):
    """
...
@tables.register("decoder_classes", "ParaformerV2SANMDecoderExport")
class ParaformerV2SANMDecoderExport(torch.nn.Module):
...
@tables.register("decoder_classes", "ParaformerV2SANMDecoderOnlineExport")
class ParaformerV2SANMDecoderOnlineExport(torch.nn.Module):
    def __init__(self, model, max_seq_len=512, model_name="decoder", onnx: bool = True, **kwargs):
        super().__init__()
        # self.embed = model.embed #Embedding(model.embed, max_seq_len)
        self.model = model
...
@tables.register("decoder_classes", "ParaformerV2SANDecoder")
class ParaformerV2SANDecoder(BaseTransformerDecoder):
    """
    Author: Speech Lab of DAMO Academy, Alibaba Group
    Paraformer: Fast and Accurate Parallel Transformer for Non-autoregressive End-to-End Speech Recognition
    https://arxiv.org/abs/2006.01713
...
@tables.register("decoder_classes", "ParaformerV2DecoderSANExport")
class ParaformerV2DecoderSANExport(torch.nn.Module):
    def __init__(
        self,
        model,
        max_seq_len=512,
